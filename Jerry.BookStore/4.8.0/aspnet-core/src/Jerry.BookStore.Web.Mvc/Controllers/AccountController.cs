...
using Jerry.BookStore.Identity;
using Jerry.BookStore.MultiTenancy;
using Jerry.BookStore.Sessions;
using Jerry.BookStore.Web.Models.Account;
using Jerry.BookStore.Web.Views.Shared.Components.TenantChange;

namespace Jerry.BookStore.Web.Controllers
{
    public class AccountController : BookStoreControllerBase
    {
